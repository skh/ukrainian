...
from app.models.entry import Lexeme, LexemeTranslation, LexemeForm, LexemeFrequency, Entry, EntryForm
...
__all__ = [
    ...
    "Lexeme", "LexemeTranslation", "LexemeForm", "LexemeFrequency", "Entry", "EntryForm",
