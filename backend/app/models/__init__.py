...
from app.models.entry import Lexeme, LexemeTranslation, LexemeForm, CorpusLemmaFrequency, CefrEntry, Entry, EntryForm
...
__all__ = [
    ...
    "Lexeme", "LexemeTranslation", "LexemeForm", "CorpusLemmaFrequency", "CefrEntry", "Entry", "EntryForm",
